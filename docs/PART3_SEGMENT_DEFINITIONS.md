...
Top-1% concentration uses `CEIL(total_entities * 0.01)` entities. Signed amount capture may be negative in the `NEGATIVE / REFUND-LIKE` band and is retained as a source-semantic diagnostic.
