...
SOURCE_DEFINITIONS = [
    ...
    ("part5_final_summary", "assets/data/part5_final_summary.json", 5, "MODEL", "DERIVED", ["modeling_lock", "champion_freeze", "oot_metrics"], ["M1", "M3", "M4"]),
    ("part5_model_selection", "assets/data/part5_model_selection.json", 5, "MODEL", "DERIVED", ["validation_leaderboard"], ["M1"]),
    ("part5_calibration", "assets/data/part5_calibration.json", 5, "MODEL", "DERIVED", ["oot_calibration"], ["M3"]),
    ("part5_topk", "assets/data/part5_topk.json", 5, "MODEL", "DERIVED", ["oot_topk"], ["M4"]),
    ("part5_summary", "assets/data/part5_summary.json", 5, "MODEL", "DERIVED", [], []),
