...
WITH candidates AS (
  SELECT segment_type, segment_value, transactions, fraud_rate, fraud_lift, fraud_capture_share, fraud_amount_capture_share, support_status FROM analytics.part3_channel_risk
  UNION ALL SELECT segment_type, segment_value, transactions, fraud_rate, fraud_lift, fraud_capture_share, fraud_amount_capture_share, support_status FROM analytics.part3_amount_band_risk
  UNION ALL SELECT segment_type, segment_value, transactions, fraud_rate, fraud_lift, fraud_capture_share, fraud_amount_capture_share, support_status FROM analytics.part3_mcc_risk
  UNION ALL SELECT segment_type, segment_value, transactions, fraud_rate, fraud_lift, fraud_capture_share, fraud_amount_capture_share, support_status FROM analytics.part3_state_risk
)
SELECT 'DEVELOPMENT_DISCOVERY' AS analysis_scope, segment_type, segment_value, transactions, fraud_rate, fraud_lift, fraud_capture_share, fraud_amount_capture_share, support_status,
